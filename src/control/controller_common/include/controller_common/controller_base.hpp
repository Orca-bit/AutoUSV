...
enum class ControlReference { TEMPORAL, SPATIAL };  // enum class ControlReference
...
public:
  ...
  BehaviorConfig(
    Real safe_deceleration_rate_mps2, std::chrono::nanoseconds time_step, ControlReference type);
...
private:
  ...
  usv::common::motion_model::CatrMotionModel32 m_model{};
