...
TEST(TrajectoryCommonTests, ValidateNonEmpty) {
  using usv::motion::motion_common::validateNonEmpty;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
...
TEST(TrajectoryCommonTests, CalcYawDeviation) {
  using usv::motion::motion_common::calcYawDeviation;
...
TEST(TrajectoryCommonTests, SearchZeroVelocityIndex) {
  using usv::motion::motion_common::searchZeroVelocityIndex;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
...
TEST(TrajectoryCommonTests, FindNearestIndex) {
  using usv::motion::motion_common::findNearestIndex;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
...
TEST(TrajectoryCommonTests, FindNearestSegmentIndex) {
  using usv::motion::motion_common::findNearestSegmentIndex;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
...
TEST(TrajectoryCommonTests, CalcLongitudinalOffsetToSegment) {
  using usv::motion::motion_common::calcLongitudinalOffsetToSegment;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
...
TEST(TrajectoryCommonTests, CalcSignedArcLengthIndexToIndex) {
  using usv::motion::motion_common::calcSignedArcLength;
  using usv::motion::motion_common::Point;
  using usv::motion::motion_common::Points;
