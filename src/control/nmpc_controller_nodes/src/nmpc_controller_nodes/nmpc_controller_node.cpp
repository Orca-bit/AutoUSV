...
{
////////////////////////////////////////////////////////////////////////////////
NmpcControllerNode::NmpcControllerNode(const std::string & name, const std::string & ns)
: ControllerBaseNode{name, ns}
{
  using nmpc_controller::LimitsConfig;
  ...
  using nmpc_controller::VehicleConfig;
  ...
  using nmpc_controller::BehaviorConfig;
  ...
  using nmpc_controller::OptimizationConfig;
  using nmpc_controller::StateWeight;
  ...
  using nmpc_controller::Interpolation;
  ...
  if (rclcpp::PARAMETER_INTEGER == debug_cycle_duration_param.get_type()) {
    ...
    if (decltype(cycle_duration)::zero() != cycle_duration) {
      m_debug_traj_pub = create_publisher<usv_msgs::msg::Trajectory>(
        "nmpc_debug_computed_trajectory", rclcpp::QoS{10LL});
...
////////////////////////////////////////////////////////////////////////////////
NmpcControllerNode::NmpcControllerNode(
