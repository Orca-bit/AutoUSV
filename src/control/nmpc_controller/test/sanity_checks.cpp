...
using motion::control::nmpc_controller::BehaviorConfig;
using motion::control::nmpc_controller::Config;
using motion::control::nmpc_controller::Interpolation;
using motion::control::nmpc_controller::LimitsConfig;
using motion::control::nmpc_controller::NmpcController;
using motion::control::nmpc_controller::OptimizationConfig;
using motion::control::nmpc_controller::Real;
using motion::control::nmpc_controller::State;
using motion::control::nmpc_controller::StateWeight;
using motion::control::nmpc_controller::VehicleConfig;
...
protected:
  LimitsConfig limits_cfg_{
    ...
    {-3.0F, 3.0F},     // Acceleration
    {-3.0F, 3.0F},     // yaw rate
    {-10.0F, 10.0F},   // Jerk
    {-200.0F, 300.0F}  // thruster
  };
  VehicleConfig vehicle_cfg_{
    1.2F,     // CG to front
    1.5F,     // CG to rear
    1.2F,     // CG to thruster long
    0.5F,     // CG to thruster lateral
    1460.0F,  // stiffness
    1460.0F,  // stiffness
    1460.0F,  // mass11
    1460.0F,  // mass22
...
{
protected:
  NmpcController controller_{Config{
    motion::motion_common::EnvironmentForces{},
    limits_cfg_,
    vehicle_cfg_,
    behavior_cfg_,
    opt_cfg_,
...
class SanityChecksOneshot : public SanityChecks, public testing::WithParamInterface<ConstantParam>
{
};
class SanityChecksSimulation : public SanityChecks,
                               public testing::WithParamInterface<ConstantParam>
{
};
...
TEST_F(SanityChecks, BackToBack)
{
  ...
  std::vector<NmpcController::Command> commands{20};
  apex_test_tools::memory_test::start();
