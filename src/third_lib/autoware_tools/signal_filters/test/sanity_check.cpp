...
namespace comp = usv::common::helper_functions::comparisons;

using usv::common::types::bool8_t;
using usv::common::types::float32_t;
using usv::common::types::float64_t;
using usv::common::signal_filters::FilterFactory;
using usv::common::signal_filters::DummyClock;
using usv::common::signal_filters::FilterType;
...
public:
  ...
  using FilterBase = usv::common::signal_filters::FilterBase<RealT, ClockT>;
