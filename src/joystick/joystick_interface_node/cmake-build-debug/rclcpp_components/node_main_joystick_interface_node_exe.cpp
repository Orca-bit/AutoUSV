...
#define NODE_MAIN_LOGGER_NAME "joystick_interface_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libjoystick_interface_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<joystick_interface_node::JoystickInterfaceNode>";
