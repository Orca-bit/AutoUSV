...
# don't use usv_set_compile_options() have this set when importing
# usv_auto_cmake via ament_auto_find_build_dependencies()
...
function(usv_set_compile_options target)
...
# Turn off optimization compiler flags for `target` unless the variable `USV_OPTIMIZATION_OF_SLOW_TARGETS` is
# defined and evaluates to `true` in a boolean context.
function(usv_turn_off_optimization target)

  if(USV_OPTIMIZATION_OF_SLOW_TARGETS)
    # do nothing
  else()
    if(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
