...
using usv::common::geometry::convex_hull;
using usv::common::geometry::dot_2d;
using usv::common::geometry::get_normal;
using usv::common::geometry::minus_2d;
using usv::common::geometry::norm_2d;
using usv::common::geometry::times_2d;
using usv_msgs::msg::BoundingBox;
using usv_msgs::msg::TrajectoryPoint;
...
template <typename Iter> std::vector<Line> get_sorted_face_list(const Iter start, const Iter end)
{
