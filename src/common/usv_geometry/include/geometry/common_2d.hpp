...
namespace comparison = usv::common::helper_functions::comparisons;
...
template <typename PointT> inline auto x_(const PointT & pt)
{
  return pt.x;
}
...
/// \return The x value of the point
/// \param[in] pt The point
inline auto x_(const usv_msgs::msg::TrajectoryPoint & pt)
{
...
/// \param[in] pt The point
/// \tparam PointT The point type
template <typename PointT> inline auto y_(const PointT & pt)
{
  return pt.y;
}
...
/// \return The y value of the point
/// \param[in] pt The point
inline auto y_(const usv_msgs::msg::TrajectoryPoint & pt)
{
...
/// \param[in] pt The point
/// \tparam PointT The point type
template <typename PointT> inline auto z_(const PointT & pt)
{
  return pt.z;
}
...
/// \return The z value of the point
/// \param[in] pt The point
inline auto z_(const usv_msgs::msg::TrajectoryPoint & pt)
{
...
/// \param[in] pt The point
/// \tparam PointT The point type
template <typename PointT> inline auto & xr_(PointT & pt)
{
  return pt.x;
}
...
inline auto & xr_(usv_msgs::msg::TrajectoryPoint & pt)
{
  return pt.pose.position.x;
}
...
/// \param[in] pt The point
/// \tparam PointT The point type
template <typename PointT> inline auto & yr_(PointT & pt)
{
  return pt.y;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & yr_(usv_msgs::msg::TrajectoryPoint & pt)
{
  return pt.pose.position.y;
}
...
/// \param[in] pt The point
/// \tparam PointT The point type
template <typename PointT> inline auto & zr_(PointT & pt)
{
  return pt.z;
}
...
/// \param[in] pt The TrajectoryPoint
inline auto & zr_(usv_msgs::msg::TrajectoryPoint & pt)
{
  return pt.pose.position.z;
}
}  // namespace point_adapter
...
template <typename IT> IT circular_next(const IT begin, const IT end, const IT current) noexcept
{
...
template <typename T1, typename T2> inline auto cross_2d(const T1 & pt, const T2 & q)
{
  using point_adapter::x_;
  using point_adapter::y_;
...
template <typename T1, typename T2> inline auto dot_2d(const T1 & pt, const T2 & q)
{
  using point_adapter::x_;
  using point_adapter::y_;
...
///         initialized
template <typename T> T minus_2d(const T & p, const T & q)
{
  T r;
  using point_adapter::x_;
  using point_adapter::y_;
...
///         initialized
template <typename T> T minus_2d(const T & p)
{
  T r;
...
///         initialized
template <typename T> T plus_2d(const T & p, const T & q)
{
  T r;
  using point_adapter::x_;
  using point_adapter::y_;
...
///         initialized
template <typename T> T times_2d(const T & p, const float32_t a)
{
  T r;
...
template <typename T> inline T intersection_2d(const T & pt, const T & u, const T & q, const T & v)
{
...
template <typename T> inline void rotate_2d(T & pt, const float32_t cos_th, const float32_t sin_th)
{
...
template <typename T> inline T rotate_2d(const T & pt, const float32_t th_rad)
{
...
template <typename T> inline T get_normal(const T & pt)
{
  T q(pt);
...
template <typename T> inline auto norm_2d(const T & pt)
{
...
template <typename T> inline T closest_segment_point_2d(const T & p, const T & q, const T & r)
{
...
//         define a line
template <typename T> inline T closest_line_point_2d(const T & p, const T & q, const T & r)
{
  const T qp = minus_2d(q, p);
...
template <typename T> inline T make_unit_vector2d(float th)
{
  T r;
...
template <typename IT> bool all_ordered(const IT begin, const IT end) noexcept
{
...
template <typename IT> auto area_2d(const IT begin, const IT end) noexcept
{
  using point_adapter::x_;
  using point_adapter::y_;
...
/// \param[in] end Iterator pointing to one past the last of the polygon points
/// \return The area of the polygon, in squared of whatever units your points are in
template <typename IT> auto area_checked_2d(const IT begin, const IT end)
{
