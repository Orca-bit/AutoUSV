...
usv_msgs::msg::Shape make_shape(const BoundingBox & box)
{
  usv_msgs::msg::Shape retval;
...
usv_msgs::msg::DetectedObject make_detected_object(const BoundingBox & box)
{
  usv_msgs::msg::DetectedObject ret;
  ...
  ret.kinematics.orientation_availability =
    usv_msgs::msg::DetectedObjectKinematics::SIGN_UNKNOWN;

  ret.shape = make_shape(box);

  ret.existence_probability = 1.0F;

  usv_msgs::msg::ObjectClassification label;
  label.classification = usv_msgs::msg::ObjectClassification::UNKNOWN;
...
std::vector<geometry_msgs::msg::Point32> GEOMETRY_PUBLIC get_transformed_corners(
  const usv_msgs::msg::Shape & shape_msg,
...
///////////////////////////////////////////////////////////////////////////////
// precompilation
using usv::common::types::PointXYZIF;
