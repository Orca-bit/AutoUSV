...
using usv::common::geometry::spatial_hash::Config2d;
using usv::common::geometry::spatial_hash::Config3d;
using usv::common::geometry::spatial_hash::SpatialHash;
using usv::common::geometry::spatial_hash::SpatialHash2d;
using usv::common::geometry::spatial_hash::SpatialHash3d;
