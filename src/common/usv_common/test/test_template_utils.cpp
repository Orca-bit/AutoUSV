...
using expression_valid_with_return =
  ::usv::common::helper_functions::expression_valid_with_return<Expression, Ts ...>;
template<template<typename> class Expression, typename ... Ts>
using expression_valid = ::usv::common::helper_functions::expression_valid<Expression, Ts ...>;
