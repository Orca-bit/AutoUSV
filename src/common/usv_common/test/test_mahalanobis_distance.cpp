...
{
  Eigen::Matrix<usv::common::types::float32_t, 2, 1> mean;
  mean << 2.F, 2.F;
  Eigen::Matrix<usv::common::types::float32_t, 2, 1> sample;
  sample << 2.F, 3.F;
  Eigen::Matrix<usv::common::types::float32_t, 2, 2> cov;
  ...
  EXPECT_FLOAT_EQ(
    usv::common::helper_functions::calculate_mahalanobis_distance(
