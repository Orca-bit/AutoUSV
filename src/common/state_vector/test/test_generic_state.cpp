...
using usv::common::state_vector::GenericState;
using usv::common::state_vector::FloatState;
using usv::common::state_vector::AngleVariable;
using usv::common::state_vector::is_state;
...
TEST(KalmanFilterGenericStateTest, Print) {
  ...
  EXPECT_EQ(
    str_stream.str(),
    "State:\n  usv::common::state_vector::variable::X: 42\n"
    "  usv::common::state_vector::variable::Y: 23\n");
}
