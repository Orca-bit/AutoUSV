...
using usv::common::motion_model::LinearMotionModel;
using usv::common::state_vector::ConstAccelerationXY32;
using usv::common::state_vector::ConstAccelerationXYYaw32;
using usv::common::state_vector::variable::X;
using usv::common::state_vector::variable::Y;
using usv::common::state_vector::variable::YAW;
using usv::common::state_vector::variable::X_VELOCITY;
using usv::common::state_vector::variable::Y_VELOCITY;
using usv::common::state_vector::variable::YAW_CHANGE_RATE;
using usv::common::state_vector::variable::X_ACCELERATION;
using usv::common::state_vector::variable::Y_ACCELERATION;
using usv::common::state_vector::variable::YAW_CHANGE_ACCELERATION;
